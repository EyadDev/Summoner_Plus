...
{
    public class CrimsonHeartMinion : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Projectile.Center = new Vector2(Main.player[Projectile.owner].Center.X + 5, Main.player[Projectile.owner].Center.Y - 115);
            Lighting.AddLight(Projectile.Center, 1, 0, 0.35f);
        }
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<CrimsonHeartMinionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<CrimsonHeartMinionBuff>()))
            {
