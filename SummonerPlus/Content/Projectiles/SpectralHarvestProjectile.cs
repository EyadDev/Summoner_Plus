...
{
	public class SpectralHarvestProjectile : ModProjectile
	{
		...
		{
            target.AddBuff(ModContent.BuffType<SupremeSpectralFlame>(), 180);

            Main.player[Projectile.owner].MinionAttackTargetNPC = target.whoAmI;

            Projectile.damage = (int)((double)damage * 0.9f);
        } 
