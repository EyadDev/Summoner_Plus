...
{
	public class NaturesCallProjectile : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit) 
		{
            ...
            target.AddBuff(ModContent.BuffType<NaturesCallDebuff>(), 180);

            Main.player[Projectile.owner].MinionAttackTargetNPC = target.whoAmI;

			if (target.type != NPCID.TargetDummy)
            {
                Main.player[Projectile.owner].AddBuff(ModContent.BuffType<NaturesRegen>(), 240);
            }

            Projectile.damage = (int)((double)damage * 0.55f);
        } 
